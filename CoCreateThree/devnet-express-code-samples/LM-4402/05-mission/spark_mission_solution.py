...
ACCESS_TOKEN 	= '' #Replace None with your access token. Shroud with quotes.
ROOM_NAME		= 'Co-Create LONDON [22 Feb 18]' #Replace None with the name of the room to be created. Shroud with quotes.
YOUR_MESSAGE 	= 'Hi Co-Create Team' #Replace None with the message that you will post to the room. Shroud with quotes.
