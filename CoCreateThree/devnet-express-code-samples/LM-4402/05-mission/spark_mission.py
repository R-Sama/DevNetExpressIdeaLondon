...
ROOM_NAME		= '' #Replace None with the name of the room to be created. Shroud with quotes.
YOUR_MESSAGE 	= '' #Replace None with the message that you will post to the room. Shroud with quotes.
